...
export default function Admin() {
  ...
  async function createCompetition() {
    ...
    if (error) {
      setMessage(
        "Could not create competition: " + error.message
      );
      return;
    }
  ...
  return (
    <main className="wrap">
      ...
      {/* AUTOMATIC RESULTS & SCORING */}

      <div className="card">
        <h3>3. Automatic Results & Scoring</h3>
        ...
        <div
          style={{
            ...
            marginTop: 14,
            borderRadius: 12,
            background: "rgba(16, 92, 57, 0.55)",
            border: "1px solid #247a50",
            color: "#b8f5cf",
            fontSize: 16,
            lineHeight: 1.55,
          }}
        >
          ...
          Results are collected automatically after matches
          finish.

          <br />
          <br />

          The round will be scored automatically when all 7
        ...
        >
          No manual result entry or scoring is required.
        </p>
      </div>
